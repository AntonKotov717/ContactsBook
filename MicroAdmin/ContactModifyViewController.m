...
- (IBAction)OnSelectCountryEdit:(id)sender {
    [self KeyboardHide];
    self.txtSelectCountry.enabled = NO;
...
-(void)KeyboardHide{
    ...
    [_txtPostalAddr resignFirstResponder];
    [_txtPostalZip resignFirstResponder];
    [_txtPostalCity resignFirstResponder];
    [_txtEnterNote resignFirstResponder];
    [_txtCompany resignFirstResponder];
    [_txtEmailAddr resignFirstResponder];
}
...
-(NSString *)makeContactRequestString{
    NSString *strKind = _txtCustomer.text;
    ...
    NSString *strGender = _txtGender.text;
